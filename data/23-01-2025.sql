...
CREATE TABLE `movie_reviews` (
  ...
  CONSTRAINT `fk_movie_reviews_review` FOREIGN KEY (`review_id`) REFERENCES `reviews` (`id`) ON DELETE CASCADE
...
INSERT INTO `movie_reviews` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,4),(5,2,5),(6,2,6),(7,3,7),(8,3,8),(9,3,9),(10,4,10),(11,4,11),(12,4,12),(13,5,13),(14,5,14),(15,5,15);
...
INSERT INTO `movies` VALUES (1,'Inception','Christopher Nolan','Science Fiction',2010,'A skilled thief is given a chance at redemption if he can successfully perform inception.','2024-11-29 10:40:13','2025-01-23 16:19:37','inception.jpg'),(2,'The Godfather','Francis Ford Coppola','Crime',1972,'The story of a powerful Italian-American crime family and their struggles.','2024-11-29 10:40:13','2025-01-23 16:19:37','the_godfather.jpg'),(3,'Titanic','James Cameron','Romance',1997,'A romantic story set against the tragic sinking of the RMS Titanic.','2024-11-29 10:40:13','2025-01-23 16:19:37','titanic.jpg'),(4,'The Matrix','The Wachowskis','Action',1999,'A hacker discovers the truth about his reality and his role in the war against its controllers.','2024-11-29 10:40:13','2025-01-23 16:19:37','matrix.jpg'),(5,'Interstellar','Christopher Nolan','Science Fiction',2014,'A team of explorers travels through a wormhole in space to save humanity.','2024-11-29 10:40:13','2025-01-23 16:19:37','interstellar.jpg');
...
-- Dump completed on 2025-01-23 17:34:38
